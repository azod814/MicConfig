...
echo -e ${GREEN}"
       ${RED}Version : ${CYAN}${__version__}

       ${RED}Hi 👋,
       ${RED}I am Azod,
       ${RED}This is only for Pentesting

       ${RED}Current Version : ${CYAN}${__version__}
       ${RED}Supported : ${CYAN}Linux, Termux
       ${RED}Developed by : ${CYAN}LxaNce-Hacker

       ${CYAN}NOTE:-
       ${RED}This Tool is made for educational purpose only,
       ${RED}Author will not be responsible for any misuse
       ${RED}of this toolkit.
"
